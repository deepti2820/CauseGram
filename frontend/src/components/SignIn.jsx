...
function SignIn() {
    ...
    const [password,setPassword]=useState("guest_20");
    const navigate=useNavigate()
    const {setUserLogin,url}=useContext(StoreContext)
    ...
    const postData=async ()=>{
        ...
        const response=await axios.post(`${url}/signin`,{email:email,password:password})
